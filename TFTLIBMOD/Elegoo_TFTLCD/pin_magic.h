...
#define DELAY7        \
...
#if defined(__AVR_ATmega168__) || defined(__AVR_ATmega328P__) || defined (__AVR_ATmega328__) || defined(__AVR_ATmega8__) || defined(__AVR_ATmega1284P__)

 // Arduino Uno, Duemilanove, etc. MODDED FOR 1284P
...
#elif defined(__AVR_ATmega1281__) || defined(__AVR_ATmega2561__) || defined(__AVR_ATmega2560__) || defined(__AVR_ATmega1280__) || defined(__AVR_ATmega1284P__)
 ...
 // Arduino Mega, ADK, etc.
  ...
  #define read8inline(result) {                                      \
    RD_ACTIVE;                                                       \
    DELAY7;                                                          \
    result = (PINB & B00000011);  									\
    RD_IDLE; }
#define setWriteDirInline() { DDRB |=  B00000011; }
#define setReadDirInline() { DDRB &= ~B00000011; }
